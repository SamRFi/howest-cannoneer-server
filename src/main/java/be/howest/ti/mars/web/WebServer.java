...
public class WebServer extends AbstractVerticle {
    ...
    public WebServer() {
        ...
        this.rtcBridge = new MarsRtcBridge(this);
        this.openApiBridge = new MarsOpenApiBridge(this);
    }

    public MarsController getController() {
        return this.controller;
    }

    public MarsOpenApiBridge getOpenApiBridge() {
        return this.openApiBridge;
    }

    public MarsRtcBridge getRtcBridge() {
