...
By default, the local setup will pick the openapi specification located at https://project-ii.ti.howest.be/monitor/apis/group-07.
...
## Production endpoints
 - H2 web client
   - https://project-ii.ti.howest.be/db-07
   - url: jdbc:h2:./db-07
   - username:group-07
   - password:see Leho for details.
 - Useful information
   - Server logs
     - https://project-ii.ti.howest.be/monitor/logs/group-07
   - Swagger Interface
     - https://project-ii.ti.howest.be/monitor/swagger/group-07
 ...
 - Web client project
   - https://project-ii.ti.howest.be/mars-07
 - Sonar
   - https://sonar.ti.howest.be/dashboard?id=2022.project-ii%3Amars-server-07
   - https://sonar.ti.howest.be/dashboard?id=2022.project-ii%3Amars-client-07
